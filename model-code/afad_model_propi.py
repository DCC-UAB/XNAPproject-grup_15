# -*- coding: utf-8 -*-
"""
Created on Tue May 14 22:23:40 2024
...
for epoch in range(num_epochs):
    ...
    for batch_idx, (features, targets) in enumerate(train_loader):
        ...
        total_cost = cost + incorrect_penalty
    ...
    wandb.log({
        'epoch': epoch,
        'train_cost': total_cost.item(),  # Se registra el costo total que incluye la penalización por error
