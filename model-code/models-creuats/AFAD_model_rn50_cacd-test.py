...
IMAGE_PATH_CACD = '/home/xnmaster/projecte/XNAPproject-grup_15/datasets_img/CACD/CACD2000-centered'
...
if args.DA_ratio < 1 and args.DA_ratio > 0:
...
BEST_MODEL_PATH = os.path.join(PATH, f'best_model_cacdtest-8-blocs-desc-DA{DA_RATIO}-{transform_num}.pth')
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = 'AFAD-RESNET-50-DESCONGELANT-8-BLOCK-MENYS-FC-DATASET-PROPI-PENULTIMA-CAPA-512-NEURONES-GUARDA-MODEL-DA-50',
        # track hyperparameters and run metadata
        config={
            "learning_rate": learning_rate,
            "architecture": "MSE",
            "model": "resnet50-pretrained - fe",
            "dataset": "afad -cacdtest",
            "epochs": num_epochs,
            }
    )
...
test_dataset = CACDDataset(
    csv_path=TEST_CSV_PATH,
    img_dir=IMAGE_PATH_CACD,
...
for epoch in range(num_epochs):
    ...
    model.eval()
    print(f"...Testing epoch [{epoch}/{num_epochs}]...")
