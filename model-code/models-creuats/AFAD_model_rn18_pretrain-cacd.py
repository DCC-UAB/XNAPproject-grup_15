...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = 'rn18-2b-DA04-pretrain-cacd',
...
def init_resnet18(num_classes, grayscale):
...
model = init_resnet18(NUM_CLASSES, GRAYSCALE)
...
for epoch in range(num_epochs):
    ...
    if test_mae < best_mae:
        ...
        torch.save(model.state_dict(), os.path.join(PATH, 'bm_rn18_pretrain-cacd.pth'))
