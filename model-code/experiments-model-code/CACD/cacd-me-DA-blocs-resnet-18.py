...
BEST_MODEL_PATH = os.path.join(PATH, f'bm-rn18-DA-desc{N_BLOCS_DESCONGELATS}-mig{N_NEURONES_MIG}-drp{DROPOUT_PROB}-fc1-{learning_rate}.pth')
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = f'RESNET18 {N_BLOCS_DESCONGELATS} descongelats - DA {DA_RATIO}% transf{transform_num}-pretrain_basic',
