...
"""
TRAIN_CSV_PATH = "/home/xnmaster/projecte/XNAPproject-grup_15/datasets/cacd_train.csv"
TEST_CSV_PATH = "/home/xnmaster/projecte/XNAPproject-grup_15/datasets/cacd_test.csv"
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = f'RESNET50 512n 6 descongelats - DA {DA_RATIO}% transf{transform_num}-pretrain_basic',
...
# Load del best model pel pretrain
if PRETRAIN_MODEL_PATH:
    load_best_model_weights(model, PRETRAIN_MODEL_PATH)
else:
    # descongelem les necessàries
