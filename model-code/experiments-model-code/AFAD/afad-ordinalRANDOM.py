...
TRAIN_CSV_PATH = './dataset_split/RANDOM_splitted_datasets/afad_splitRANDOM_train.csv'
TEST_CSV_PATH = './dataset_split/RANDOM_splitted_datasets/afad_splitRANDOM_test.csv'
IMAGE_PATH = 'datasets_img/AFAD/AFAD-Full'
VALID_CSV_PATH = './dataset_split/RANDOM_splitted_datasets/afad_splitRANDOM_valid.csv'
...
for epoch in range(num_epochs):
    ...
    with torch.set_grad_enabled(False):
        ...
        wandb.log({'Train MAE': train_mae.item(), 'Train RMSE': torch.sqrt(train_mse).item(),
                ...
                'epoch': epoch, 'Valid MAE':valid_mae, 'Valid RMSE':torch.sqrt(valid_mse).item()})
