...
BEST_MODEL_PATH = os.path.join(PATH, f'bm-rn50-DA-desc{N_BLOCS_DESCONGELATS}-mig{N_NEURONES_MIG}-drp{DROPOUT_PROB}-fc1.pth')
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        config={
            ...
            "architecture": "MSE",
            "model": f"resnet50 6 descongelats - DA {DA_RATIO}% {transform_num}",
            "dataset": "afad",
            "epochs": num_epochs,
            }
    )
