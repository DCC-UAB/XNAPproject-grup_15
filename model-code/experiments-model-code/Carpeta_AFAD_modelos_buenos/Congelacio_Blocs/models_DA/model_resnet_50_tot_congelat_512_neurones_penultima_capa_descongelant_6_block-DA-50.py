...
BEST_MODEL_PATH = os.path.join(PATH, 'best_model_actual-DA100-1.pth')
...
train_dataset = AFADDatasetAge(
    ...
    augmentation_transform=augmentation_transform1,
    augment_ratio=0.5  # 100% of the data will be augmented
)
