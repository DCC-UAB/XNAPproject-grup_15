...
BEST_MODEL_PATH = os.path.join(PATH, 'best_model_actual-DA30-1.pth')
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = 'AFAD-RESNET-50-DESCONGELANT-6-BLOCK-MENYS-FC-DATASET-PROPI-PENULTIMA-CAPA-512-NEURONES-GUARDA-MODEL - DA - 30',
        # track hyperparameters and run metadata
        config={
            "learning_rate": learning_rate,
            "architecture": "MSE",
            "model": "resnet50 6 descongelats - DA 100% transform1",
            "dataset": "afad",
            "epochs": num_epochs,
            }
    )
...
train_dataset = AFADDatasetAge(
    ...
    augment_ratio=0.3  # 100% of the data will be augmented
)
