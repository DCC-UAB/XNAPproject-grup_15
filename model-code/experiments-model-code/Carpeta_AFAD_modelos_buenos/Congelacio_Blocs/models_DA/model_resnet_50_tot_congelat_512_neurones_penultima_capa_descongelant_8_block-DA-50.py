...
BEST_MODEL_PATH = os.path.join(PATH, f'best_model_actual-8-blocs-desc-DA{DA_RATIO}-{transform_num}.pth')
...
load_best_model_weights(model, "/home/xnmaster/projecte/XNAPproject-grup_15/model-code/experiments-model-code/Carpeta_AFAD_modelos_buenos/Congelacio_Blocs/best_model_actual.pth")
