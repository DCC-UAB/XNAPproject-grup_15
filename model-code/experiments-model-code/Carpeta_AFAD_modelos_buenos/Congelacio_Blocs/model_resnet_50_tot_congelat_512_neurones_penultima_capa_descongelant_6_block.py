...
BEST_MODEL_PATH = os.path.join(PATH, 'best_model_actual.pth')
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = 'AFAD-RESNET-50-DESCONGELANT-6-BLOCK-MENYS-FC-DATASET-PROPI-PENULTIMA-CAPA-512-NEURONES-GUARDA-MODEL',
