...
print(os.getcwd(),'\n\n\n')
TRAIN_CSV_PATH = '/home/xnmaster/projecte/XNAPproject-grup_15/datasets/afad_train.csv'
TEST_CSV_PATH = '/home/xnmaster/projecte/XNAPproject-grup_15/datasets/afad_test.csv'
...
wandb.init(
    # set the wandb project where this run will be logged
        ...
        name = 'AFAD-RESNET-101-TOT-CONGELAT-MENYS-FC-DATASET-ORIGINAL',
...
def init_resnet101(num_classes, grayscale):
...
model = init_resnet101(NUM_CLASSES, GRAYSCALE)
model.to(DEVICE)
params_to_update = []
